    ...
    public class ServiceListViewModel : BaseViewModel
    {
        ...
        public IService SelectedService
        {
            ...
            set
            {
                if (value != null)
                {
                    Debug.WriteLine("nowIdToString         " + value.Id.ToString());
                    Debug.WriteLine("nowToString           " + value.ToString());
                    Debug.WriteLine("now                   " + value.Device);
                    Debug.WriteLine("now                   " + value.Name);
                    Debug.WriteLine("now                   " + value.IsPrimary);
                    Debug.WriteLine("now                   " + value.GetCharacteristicsAsync());
